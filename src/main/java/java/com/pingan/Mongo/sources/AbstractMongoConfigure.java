...
public abstract class AbstractMongoConfigure {
	...
	@Value("${spring.qhzx.mongodb.host}")
	private String host;
	@Value("${spring.qhzx.mongodb.database}")
	private String database;
	@Value("${spring.qhzx.mongodb.port}")
	private int port;
	@Value("${spring.qhzx.mongodb.username}")
	private String username;
	@Value("${spring.qhzx.mongodb.password}")
